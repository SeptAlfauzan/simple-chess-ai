...
const DEPTH = localStorage.getItem('level');
if (!DEPTH) {
  alert('please select level on main menu first!');
  location.href = '/';
}
...
const calculateBestMove = function (game, playerColor, alpha = Number.NEGATIVE_INFINITY, beta = Number.POSITIVE_INFINITY, isMaximizing = true, depth = DEPTH) {
  // base case
  if (depth == 0) {
